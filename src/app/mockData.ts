...
import { genTimeseries, genDriftTimeseries, uid } from './utils';
...
export const metrics: Metric[] = [
  ...
  // Extraction
  { id: 'li-1', facilityId: 'fac-1', name: 'Distillation Vacuum', unit: 'mmHg', area: 'Extraction', asset: 'Distillation', normalRange: { min: 680, max: 720 }, tags: ['distillation', 'vacuum'], description: 'Distillation column vacuum pressure', timeseries: genDriftTimeseries(24, 700, 15, 660, 0.40) },
  { id: 'li-2', facilityId: 'fac-1', name: 'DT Dome Temperature', unit: '°C', area: 'Extraction', asset: 'Desolventizer-Toaster', normalRange: { min: 60, max: 75 }, tags: ['dt', 'temperature'], description: 'Desolventizer-Toaster dome temperature', timeseries: genDriftTimeseries(24, 68, 5, 55, 0.45) },
  { id: 'li-3', facilityId: 'fac-1', name: 'DT Deck Steam Flow', unit: 'kg/h', area: 'Extraction', asset: 'Desolventizer-Toaster', normalRange: { min: 800, max: 1200 }, tags: ['dt', 'steam'], description: 'DT deck steam flow rate', timeseries: genDriftTimeseries(24, 1000, 100, 700, 0.40) },
  ...
  { id: 'li-5', facilityId: 'fac-1', name: 'DT %FLA', unit: '%', area: 'Extraction', asset: 'Desolventizer-Toaster', normalRange: { min: 50, max: 80 }, tags: ['dt', 'fla'], description: 'DT full load amperage percentage', timeseries: genDriftTimeseries(24, 65, 10, 88, 0.35) },
  { id: 'li-6', facilityId: 'fac-1', name: 'Extraction Final Vent LEL', unit: '%LEL', area: 'Extraction', asset: 'Final Vent', normalRange: { min: 0, max: 20 }, tags: ['extraction', 'lel', 'safety'], description: 'Extraction final vent lower explosive limit', timeseries: genDriftTimeseries(24, 8, 5, 25, 0.50) },
  { id: 'li-7', facilityId: 'fac-1', name: 'Extractor Pressure', unit: 'mbar', area: 'Extraction', asset: 'Extractor', normalRange: { min: -5, max: 5 }, tags: ['extractor', 'pressure'], description: 'Extractor operating pressure', timeseries: genDriftTimeseries(24, 0.5, 3, 8, 0.40) },
  { id: 'li-8', facilityId: 'fac-1', name: 'Solvent Ratio', unit: 'ratio', area: 'Extraction', asset: 'Solvent System', normalRange: { min: 0.8, max: 1.2 }, tags: ['solvent', 'ratio'], description: 'Solvent-to-feed ratio', timeseries: genDriftTimeseries(24, 1.0, 0.12, 0.65, 0.45) },
  { id: 'li-9', facilityId: 'fac-1', name: 'Solvent Temperature to Extractor', unit: '°C', area: 'Extraction', asset: 'Solvent System', normalRange: { min: 50, max: 60 }, tags: ['solvent', 'temperature'], description: 'Solvent feed temperature', timeseries: genDriftTimeseries(24, 55, 3, 46, 0.40) },
  ...
  { id: 'li-11', facilityId: 'fac-1', name: 'Reboiler Temperature', unit: '°C', area: 'Extraction', asset: 'Reboiler', normalRange: { min: 105, max: 115 }, tags: ['reboiler', 'temperature'], description: 'Reboiler operating temperature', timeseries: genDriftTimeseries(24, 110, 3, 120, 0.40) },
  { id: 'li-12', facilityId: 'fac-1', name: 'Reboiler Steam Flow', unit: 'kg/h', area: 'Extraction', asset: 'Reboiler', normalRange: { min: 600, max: 900 }, tags: ['reboiler', 'steam'], description: 'Reboiler steam flow rate', timeseries: genDriftTimeseries(24, 750, 75, 950, 0.35) },
  ...
  // Preparation
  { id: 'li-14', facilityId: 'fac-1', name: 'Flake Thickness', unit: 'mm', area: 'Preparation', asset: 'Flaker', normalRange: { min: 0.25, max: 0.35 }, tags: ['flake', 'thickness'], description: 'Flake thickness measurement', timeseries: genDriftTimeseries(24, 0.30, 0.03, 0.40, 0.38) },
  { id: 'li-15', facilityId: 'fac-1', name: 'Flaker Full Load Amperage', unit: '%FLA', area: 'Preparation', asset: 'Flaker', normalRange: { min: 60, max: 85 }, tags: ['flaker', 'amps'], description: 'Flaker motor load', timeseries: genDriftTimeseries(24, 72, 8, 92, 0.35) },
  ...
  { id: 'li-18', facilityId: 'fac-1', name: 'Conditioning Discharge Temperature', unit: '°C', area: 'Preparation', asset: 'Conditioner', normalRange: { min: 55, max: 65 }, tags: ['conditioning', 'temperature'], description: 'Conditioning discharge temperature', timeseries: genDriftTimeseries(24, 60, 3, 70, 0.42) },
  // Boiler / Utilities
  { id: 'li-19', facilityId: 'fac-1', name: 'Boiler Steam Pressure', unit: 'bar', area: 'Utilities', asset: 'Boiler', normalRange: { min: 8, max: 12 }, tags: ['boiler', 'pressure'], description: 'Main boiler steam pressure', timeseries: genDriftTimeseries(24, 10, 1, 7, 0.38) },
  { id: 'li-20', facilityId: 'fac-1', name: 'Boiler Feedwater Temperature', unit: '°C', area: 'Utilities', asset: 'Boiler', normalRange: { min: 85, max: 105 }, tags: ['boiler', 'feedwater', 'temperature'], description: 'Boiler feedwater temperature', timeseries: genDriftTimeseries(24, 95, 5, 80, 0.42) },
  ...
  { id: 'li-22', facilityId: 'fac-1', name: 'Boiler Water Conductivity', unit: 'µS/cm', area: 'Utilities', asset: 'Boiler', normalRange: { min: 1000, max: 3000 }, tags: ['boiler', 'conductivity'], description: 'Boiler water conductivity inline', timeseries: genDriftTimeseries(24, 2000, 400, 3500, 0.35) },
  // Dehulling
...
export const anomalies: Anomaly[] = [
  {
    ...
    relatedMetricIds: ['li-2', 'li-3', 'li-4', 'li-5', 'met-1', 'met-2'], drivers: [
  ...
  },
  {
    ...
    relatedMetricIds: ['li-6', 'li-7', 'li-1', 'met-7'], drivers: [
  ...
  },
  {
    ...
    relatedMetricIds: ['li-8', 'li-9', 'li-10', 'met-2', 'met-7'], drivers: [
  ...
  },
  {
    ...
    relatedMetricIds: ['li-14', 'li-15', 'met-1', 'met-2'], drivers: [
  ...
  },
  {
    ...
    relatedMetricIds: ['li-11', 'li-12', 'li-13', 'met-6'], drivers: [
  ...
  },
  {
    ...
    relatedMetricIds: ['li-18', 'met-3', 'met-8'], drivers: [
  ...
  },
  {
    ...
    relatedMetricIds: ['li-1', 'li-11', 'met-7', 'met-6'], drivers: [
  ...
  },
  {
    ...
    relatedMetricIds: ['li-20', 'li-19', 'li-22', 'met-6', 'met-9', 'met-10'], drivers: [
...
export const actions: Action[] = [
  { id: 'act-1', anomalyId: 'ano-1', title: 'Check steam header pressure and supply to DT', type: 'Inspect', assigneeGroup: 'Operations', assigneeName: 'John K.', assigneeUserId: 'u-1', priority: 'High', dueAt: now + h(4), status: 'In Progress', notes: [{ ts: now - h(1), userId: 'u-1', text: 'Steam header at 8.2 bar — slightly low. Investigating trap on line 3.' }] },
  { id: 'act-2', anomalyId: 'ano-1', title: 'Calibrate DT dome temperature sensor', type: 'Calibrate', assigneeGroup: 'Instrumentation', assigneeUserId: 'u-2', priority: 'High', dueAt: now + h(6), status: 'Done', completedAt: now - h(1), notes: [{ ts: now - h(1), userId: 'u-2', text: 'Sensor recalibrated. Reading within ±0.5°C.' }] },
  { id: 'act-3', anomalyId: 'ano-3', title: 'Adjust solvent flow valve and verify ratio', type: 'Adjust', assigneeGroup: 'Operations', assigneeUserId: 'u-2', priority: 'Medium', dueAt: now + h(8), status: 'Done', completedAt: now - h(2), notes: [{ ts: now - h(2), userId: 'u-2', text: 'Valve repositioned. Ratio recovering to 0.82.' }] },
  { id: 'act-4', anomalyId: 'ano-4', title: 'Inspect flaker roll bearings and alignment', type: 'Inspect', assigneeGroup: 'Maintenance', assigneeUserId: 'u-1', priority: 'Low', dueAt: now + h(12), status: 'Done', completedAt: now - h(3), notes: [{ ts: now - h(3), userId: 'u-1', text: 'Left bearing showing wear. Replacement scheduled.' }] },
  { id: 'act-5', anomalyId: 'ano-4', title: 'Calibrate flaker roll pressure sensors L/R', type: 'Calibrate', assigneeGroup: 'Instrumentation', assigneeUserId: 'u-3', priority: 'Low', dueAt: now + h(24), status: 'Verified', completedAt: now - h(6), notes: [{ ts: now - h(6), userId: 'u-3', text: 'Both sensors calibrated and verified against reference.' }] },
  { id: 'act-6', anomalyId: 'ano-5', title: 'Throttle reboiler steam valve to reduce temp', type: 'Adjust', assigneeGroup: 'Operations', assigneeName: 'Lisa M.', assigneeUserId: 'u-1', priority: 'High', dueAt: now + h(2), status: 'Done', completedAt: now - h(8), notes: [{ ts: now - h(10), userId: 'u-1', text: 'Valve throttled from 75% to 60%. Monitoring temp response.' }] },
  { id: 'act-7', anomalyId: 'ano-5', title: 'Inspect reboiler steam control valve positioner', type: 'Inspect', assigneeGroup: 'Instrumentation', assigneeUserId: 'u-2', priority: 'Medium', dueAt: now + h(48), status: 'New', notes: [] },
  { id: 'act-8', anomalyId: 'ano-7', title: 'Clean distillation condenser', type: 'Clean', assigneeGroup: 'Maintenance', assigneeName: 'Tom R.', assigneeUserId: 'u-2', priority: 'High', dueAt: now - h(62), status: 'Verified', completedAt: now - h(62), notes: [{ ts: now - h(62), userId: 'u-2', text: 'Condenser descaled and tested. Vacuum restored to 705 mmHg.' }] },
  { id: 'act-9', anomalyId: 'ano-2', title: 'Inspect extraction vent system and seals', type: 'Inspect', assigneeGroup: 'Maintenance', assigneeUserId: 'u-1', priority: 'High', dueAt: now + h(4), status: 'Done', completedAt: now - h(0.5), notes: [{ ts: now - h(0.5), userId: 'u-1', text: 'Seals intact. Minor vent blockage cleared.' }] },
  { id: 'act-10', anomalyId: 'ano-8', title: 'Inspect deaerator steam supply and traps', type: 'Inspect', assigneeGroup: 'Maintenance', assigneeUserId: 'u-3', priority: 'Medium', dueAt: now + h(10), status: 'New', notes: [] },
];
